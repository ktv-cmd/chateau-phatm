  ...
  return (
    <div className="min-h-screen py-8 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-gray-600 mb-8">Chateau Drug &amp; Homecare — Admin Panel</p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="card">
            <h2 className="text-sm font-semibold text-gray-600 mb-1">New Refills</h2>
            <p className="text-3xl font-bold text-purple-600">{stats.newRefills}</p>
          </div>
          <div className="card">
            <h2 className="text-sm font-semibold text-gray-600 mb-1">Total Products</h2>
